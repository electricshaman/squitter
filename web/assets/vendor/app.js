								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(aircraft.altitude)),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_elm_lang$core$Basics$toString(aircraft.velocity_kt)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_elm_lang$core$Basics$toString(aircraft.vr)),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{ctor: '[]'},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_elm_lang$core$Basics$toString(aircraft.distance)),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{ctor: '[]'},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(
															_elm_lang$core$Basics$toString(aircraft.heading)),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{ctor: '[]'},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																_elm_lang$core$Basics$toString(aircraft.position.lat)),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{ctor: '[]'},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(
																	_elm_lang$core$Basics$toString(aircraft.position.lon)),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{ctor: '[]'},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(
																		_elm_lang$core$Basics$toString(aircraft.msgs)),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Aircraft'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					},
					{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('ICAO'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Squawk'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Altitude (ft)'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Speed (kt)'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Vertical Rate (ft/min)'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Distance (NM)'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								A2(
									_elm_lang$core$List$map,
									_user$project$App$aircraftRow,
									_elm_lang$core$Dict$values(model.aircraft))),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$App$socket = _saschatimme$elm_phoenix$Phoenix_Socket$init('ws://localhost:4000/socket/websocket');
var _user$project$App$AircraftCategory = F2(
	function (a, b) {
		return {set: a, category: b};
	});
var _user$project$App$decodeCategory = A3(
	...
	A3(
		...
		'set',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$App$AircraftCategory)));
var _user$project$App$AircraftPosition = F2(
	function (a, b) {
		return {lat: a, lon: b};
	});
var _user$project$App$decodePosition = A4(
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {address: a, callsign: b, country: c, registration: d, squawk: e, altitude: f, vr: g, vr_dir: h, velocity_kt: i, category: j, heading: k, position: l, distance: m, msgs: n, age: o};
														};
													};
												};
											};
	...
	A3(
		...
		A3(
			...
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'position',
				_user$project$App$decodePosition,
				A4(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
					'heading',
					_elm_lang$core$Json_Decode$int,
					...
					A3(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
						'category',
						_user$project$App$decodeCategory,
						A4(
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
							'velocity_kt',
							_elm_lang$core$Json_Decode$int,
...
var _user$project$App$init = {
	ctor: '_Tuple2',
	_0: _user$project$App$Model(_elm_lang$core$Dict$empty),
	_1: _elm_lang$core$Platform_Cmd$none
};
...
var _user$project$App$subscriptions = function (model) {
	return A2(
		_saschatimme$elm_phoenix$Phoenix$connect,
		_user$project$App$socket,
		{
			ctor: '::',
			_0: _user$project$App$channel,
			_1: {ctor: '[]'}
		});
};
var _user$project$App$main = _elm_lang$html$Html$program(
	{init: _user$project$App$init, subscriptions: _user$project$App$subscriptions, view: _user$project$App$view, update: _user$project$App$update})();
